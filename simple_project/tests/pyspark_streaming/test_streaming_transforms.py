...
CHECKPOINT_LOCATION_LOCAL = "/dbfs/Users/dustin.vannoy@databricks.com/field_demos/test_streaming_autloader_checkpoint"

SOURCE_PATH = "dbfs:/Users/dustin.vannoy@databricks.com/field_demos/test_csv"
SOURCE_PATH_LOCAL = "/dbfs/Users/dustin.vannoy@databricks.com/field_demos/test_csv"
...
def test_simple():
  t = dbutils.fs.ls(SOURCE_PATH) #.get_secret('fieldeng', 'dustin-secret')
  print(t)
  s = dbutils.secrets.get("fieldeng", "dustin-secret")
  assert s == "test2"
  assert t.pop().path.find("dbfs:/Users/dustin.vannoy@databricks.com/field_demos/test_csv") > -1
