...
def read_autoloader(path, checkpoint_location):
  ...
  streaming_df = spark.readStream.format("cloudFiles") \
      ...
      # .option("cloudFiles.schemaLocation", checkpoint_location+"/shema") \
...
# %fs ls dbfs:/Users/dustin.vannoy@databricks.com/field_demos/test_csv

# COMMAND ----------

# DBTITLE 1,Reset source data
QUERY_NAME = "streaming_unit_test"
SOURCE_PATH = "dbfs:/Users/dustin.vannoy@databricks.com/field_demos/test_csv"
CHECKPOINT_LOCATION = "dbfs:/Users/dustin.vannoy@databricks.com/field_demos/test_streaming_autloader_checkpoint"

dbutils.fs.rm(SOURCE_PATH, recurse=True)

dbutils.fs.rm(CHECKPOINT_LOCATION, recurse=True)

dbutils.fs.mkdirs("dbfs:/Users/dustin.vannoy@databricks.com/field_demos/test_csv")
...
text3 = """1987,10,19,1,749,730,922,849,PS,1451,NA,93,79,NA,33,19,SAN,SFO,447,NA,NA,0,NA,0,NA,NA,NA,NA,NA,YES,YES"""
...
def write_source_batch(part, text):
  with open(f"/dbfs/Users/dustin.vannoy@databricks.com/field_demos/test_csv/{part}.csv", 'w') as f:
    f.write(text)
